...
<head>
  ...
  <title>會員資訊 | 第十二區管理處供水調配操控整合管理系統</title>
...
<body onload="showtime();">
  ...
  <script language="javascript">
    ...
    function getDataAuthor() {
      var url = "http://220.134.42.63:8080/WaterscadaAPI/GetUserInfo?user_id";
    ...
    function grid_author(xdata) {
        ...
        $("#grid_author").kendoGrid({
            ...
            columns: [
                { field: "ID", title: "ID",  width: "100px", hidden: false,},
...
//                          }
                ...
                { field: "WEB_FRONTEND", title:"網站權限名稱", width: "100px"},
                { field: "WEB_BACKEND", title:"系統管理權限名稱", width: "100px"},
                { field: "CITY", title:"場站(R)", width: "60px", hidden: false },
                { field: "CITY_WRITE", title:"場站(R/W)",  width: "60px", hidden: false },
                { field: "REPORT", title:"報表(R)", width: "60px", hidden: false },
                { field: "REPORT_WRITE", title:"報表(R/W)",  width: "60px", hidden: false },                
                { command: [{ name: "edit", text: "修改"} , 
                            { className: "btn-destroy", name: "delete", text: "移除", iconClass: "k-icon k-i-delete",
                              click: function(e){
                              var itemDataObj = {};
                              var url_="http://220.134.42.63:8080/WaterscadaAPI/PostUser_delete";
