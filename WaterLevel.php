    ...
    <!-- #top_header [top] -->
        ...
        <ul>
          ...
          <ul class="child_menu">
             <li><a href="javascript:void(0)" class=" " onclick="console.log($(this).next('.show_popinfo').fadeToggle('fast'))">
              ...
              <li><a href="./WaterLevel.php" class="active ">
                  <div class="pic"><img src="images/m2.png" /></div>
                  水位總覽圖
                </a>
              </li>
      ...
      <!-- main_menu [end] -->         
        ...
        <div id="dsr_Info" class="container1">
          <div class="contan">
            <ul class="tab_sheet">
              <li class="active"><span>全區水位總覽圖 1</span></li>        
              <li><span>全區水位總覽圖 2</span></li>              
            </ul>
            <div id="tab_contant">
              <div id="weatherForecast" class="tab active">
                <img src="../WaterScada/IFIX_PIC/(光復iFIX-VM)水位總覽圖.grf.png" alt="(光復iFIX-VM)水位總覽圖.grf" style="width:100%">
              </div>
              <div id="mountainRainfall" class="tab ">
                <img src="../WaterScada/IFIX_PIC/(光復iFIX-VM)水位總覽圖1.grf.png" alt="(光復iFIX-VM)水位總覽圖1.grf" style="width:100%">
              </div>              
            </div>
          </div>
        </div>
