...
<head>
  ...
  <title>原水三峽河 | 第十二區管理處供水調配操控整合管理系統</title>
  ...
  <link rel="stylesheet" href="css/WaterSanxia.css">
...
<body onload="showtime();">
          ...
          <li class="active"><a href="#" class="m2"><img src="images/icons/btn-icon02a.png" />即時水情看板<span>Instant board</span></a>
            <ul class="child_menu">
             <li><a href="javascript:void(0)" class=" " onclick="console.log($(this).next('.show_popinfo').fadeToggle('fast'))">
              ...
              <li><a href="./WaterSanxia.php" class="active ">
                  <div class="pic"><img src="images/m2.png" /></div>
                  原水三峽河
                </a></li>
  ...
  <div class="balaImg">
    <div id="mappingConte">
      ...
      <img src="images/Dashboard/waterSanxia.png" style="width:100%">
      <div class="setposition-Moto">
        <div class="x1 y1"><span>三峽河抽水機#1</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition-Moto">
        <div class="x1 y2"><span>三峽河抽水機#2</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition-Moto">
        <div class="x1 y3"><span>三峽河抽水機#3</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition-Moto">
        <div class="x2 y1"><span>三峽河抽水機#4</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition-Moto">
        <div class="x2 y2"><span>三峽河抽水機#5</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition-Moto">
        <div class="x2 y3"><span>三峽河抽水機#6</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition-Moto">
        <div class="x3 y1"><span>三峽河抽水機#7</span><img src="./images/icons/light-green-s.png"></div>
      </div>
      <div class="setposition">
        <div class="x4 y4"><span>三峽河取水站</span><span>瞬間流量</span><input type="text" value=""></div>
      </div>
      <div class="setposition">
        <div class="x4 y5"><span>三峽河取水站</span><span>累積流量</span><input type="text" value=""></div>
      </div>
      <div class="setposition">
        <div class="x4 y6"><span>三峽河取水站</span><span>濁度</span><input type="text" value=""></div>
      </div>
      <div class="setposition">
        <div class="x4 y7"><span>三峽河取水站</span><span>水位</span><input type="text" value=""></div>
      </div>      
    </div>
  </div>
  <input id="section_" type="hidden" placeholder="section" value="全區供水調配">
  <input id="item_" type="hidden" placeholder="item" value="3">
