...
<!--  <script type="text/javascript" src="http://api.tgos.nat.gov.tw/TGOS_API/tgos?ver=2&AppID=7ihe5D1S7sQQEbTEc3ilpmtCKih3hbL0t5Qn2csKd7j9J5KQNOeNMQ==&APIKey=" charset="utf-8"></script>-->
  <!-- development -->
  <!--    <script type="text/javascript" src="https://api.tgos.tw/TGOS_API/tgos?ver=2&AppID=U0xdhYjYUdCUrjNfQeR4lZEj5Lduuqimv9VUoWNq1y5P1Lb5JyFO1w==&APIKey=" charset="utf-8"></script>-->
  <meta charset="utf-8">
...
/*      z-index: 400 !important;*/
    ...
    .demo-section .k-dropdown-wrap .k-clear-value {
      top: 15px !important;  
    }
  </style>
...
<!--            <a onclick="javascript:this.firstElementChild.click();activePhyic(this,'水位'); activeCheck(this.parentElement);"><input id="Elev_DR" name="elev_msr" value="配水池" type="hidden"><img src="images/icons/menu-sub-7.png">配水池<span></span></a>-->
  ...
  <!-- 測站 -->
  <input type="hidden" id="Elev_MSR" value="" placeholder="測站內容存放" style="background-color: yellow; z-index: 1000; position: relative; z-index: 1000; position: relative; top: 970px; width: 100%;">
  <!-- 流量計 -->
  ...
  <div class="" id="OMap" style="max-width:100%;height: 100vh;border: 1px solid #C0C0C0;">
    <div class="togglefloatLeng" title="統計計量點">
          ...
          <div class="dataCCTV" style="background-color: black">
            ...
            <div class="dataCCTV_wrapper">
              <div class="dataCCTV_content cctv_block0">
                <div class="dataCCTV_content_title"><img src="./images/icons/cctv-icon4.png" alt=""><span>CAM1</span>
              ...
              <div class="dataCCTV_content cctv_block1">
                <div class="dataCCTV_content_title"><img src="./images/icons/cctv-icon4.png" alt=""><span>CAM2</span>
                  <div class="dataCCTV_content_controll"><img src="" alt=""></div>
                </div>
                <div class="dataCCTV_content_cam ">
                  <div class="cam">
              ...
              <div class="dataCCTV_content cctv_block2">
                <div class="dataCCTV_content_title"><img src="./images/icons/cctv-icon4.png" alt=""><span>CAM3</span>
                  <div class="dataCCTV_content_controll"><img src="" alt=""></div>
                </div>
                <div class="dataCCTV_content_cam ">
                  <div class="cam">
              ...
              <div class="dataCCTV_content cctv_block3">
                <div class="dataCCTV_content_title"><img src="./images/icons/cctv-icon4.png" alt=""><span>CAM4</span>
                  <div class="dataCCTV_content_controll"><img src="" alt=""></div>
                </div>
                <div class="dataCCTV_content_cam ">
                  <div class="cam">
...
-->
  <div id="filterWrapper" class="filterWrapperInvisible">
      ...
      columns: [
        {
          ...
          template: "<div class='searchUnit' style='font-size:12px;' onclick='infoWindowControll(" + "\"#: STATION_ID #\"" + ", true);'>#: CITY #</div>",
//          template: "<div class='searchUnit' style='font-size:12px; onclick='infoWindowControll(" + "\"#: STATION_ID #\"" + ", true);'>#: CITY #</div>",
          width: 150
        },
      ],
  ...
  <script>
    ...
    function setStationInfo(sta_id) {
      ...
      var temp = [],  temp2 = [],  temp4 = [],  temp3 = [],  getStateIndex = [],  getStateData = [];
      var StaIdName;
      //      var StateValue = [];
