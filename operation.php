...
<body onload="showtime();">
  ...
  <div id="dsr_Info" class="container1">
    <div class="contan">
      <ul class="tab_sheet">
        <li class="active"><span><a href="./operation.php">操作手冊</a></span></li>
      ...
      <div id="tab_contant">
        <div id="operation1" class="tab active">
        ...
        <div id="operation2" class="tab "></div>
        <div id="operation3" class="tab "></div>
      </div>
    </div>
  </div>
  ...
  <script language="javascript">
    ...
    $("#uploadForm").on('submit', (function(e) {
      ...
      $.ajax({
        ...
        error: function() {alert("上傳失敗，請重新上傳。");}
      });
    }));
