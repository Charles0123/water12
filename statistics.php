  ...
  <div id="dsr_Info" class="container1">
    <div class="contan">
      <ul class="tab_sheet">
        ...
        <li class="active"><span><a href="./statistics.php">站場點位統計總表</a></span></li>
      </ul>
      <div id="tab_contant">
        ...
        <div id="operation3" class="tab active">
          <div class="tab-content">
              ...
              <style type="text/css">
                ...
                .tg td{font-family:Arial, sans-serif;font-size:14px;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:black;color:#fff;}
                .tg th{font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:black;color:#fff;}
                .tg .tg-9wq8{border-color:inherit;text-align:center;vertical-align:middle}
                .tg .tg-c3ow{border-color:inherit;text-align:center;vertical-align:top}
                .tg .tg-0pky{border-color:inherit;text-align:left;vertical-align:top;text-align:center}
                .tg .tg-dvpl{border-color:inherit;text-align:right;vertical-align:top;padding-right:6px !important;}
                .tg .tg-yz93{border-color:inherit;text-align:right;vertical-align:middle;padding-right:6px !important;}
                </style>
                ...
                <col style="width: 20%">
                  ...
                  <tr>
                    <th class="tg-9wq8">場所名稱</th>
                    <th class="tg-9wq8">場站數量</th>
                    <th class="tg-c3ow">全部點數<br>(不含小區)</th>
                    <th class="tg-c3ow">小區管網<br>八大類點數</th>
                  </tr>
                  <tr>
                    <td class="tg-0pky">板新給水廠(廠內)</td>
                    <td class="tg-dvpl">18</td>
                    <td class="tg-dvpl">8,560</td>
                    <td class="tg-yz93" rowspan="4">108</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">板新給水廠(廠外)</td>
                    <td class="tg-dvpl">15</td>
                    <td class="tg-dvpl">1,603</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">光復加壓站(站內)</td>
                    <td class="tg-dvpl">1</td>
                    <td class="tg-dvpl">1,595</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">光復加壓站(站外)</td>
                    <td class="tg-dvpl">8</td>
                    <td class="tg-dvpl">2,179</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">樹林服務所</td>
                    <td class="tg-dvpl">29</td>
                    <td class="tg-dvpl">677</td>
                    <td class="tg-dvpl">414</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">鶯歌服務所</td>
                    <td class="tg-dvpl">20</td>
                    <td class="tg-dvpl">831</td>
                    <td class="tg-dvpl">424</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">土城服務所</td>
                    <td class="tg-dvpl">23</td>
                    <td class="tg-dvpl">1,224</td>
                    <td class="tg-dvpl">404</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">泰山營運所</td>
                    <td class="tg-dvpl">34</td>
                    <td class="tg-dvpl">1,527</td>
                    <td class="tg-dvpl">483</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">蘆洲服務所</td>
                    <td class="tg-dvpl">18</td>
                    <td class="tg-dvpl">1,331</td>
                    <td class="tg-dvpl">409</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">新莊服務所</td>
                    <td class="tg-dvpl">18</td>
                    <td class="tg-dvpl">329</td>
                    <td class="tg-dvpl">428</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">板橋服務所</td>
                    <td class="tg-dvpl">11</td>
                    <td class="tg-dvpl">394</td>
                    <td class="tg-dvpl">366</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky">業務課</td>
                    <td class="tg-dvpl">-</td>
                    <td class="tg-dvpl">-</td>
                    <td class="tg-dvpl">212</td>
                  </tr>
                  <tr>
                    <td class="tg-0pky"></td>
                    <td class="tg-dvpl">195</td>
                    <td class="tg-dvpl">20,250</td>
                    <td class="tg-dvpl">3,248</td>
                  </tr>
                </table>
              </div>
              <br/>
